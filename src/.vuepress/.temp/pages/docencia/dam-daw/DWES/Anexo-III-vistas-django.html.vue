<template><div><h1 id="🐍-anexo-iii-vistas-en-django-para-la-aplicacion-myong" tabindex="-1"><a class="header-anchor" href="#🐍-anexo-iii-vistas-en-django-para-la-aplicacion-myong"><span>🐍 Anexo III: Vistas en Django para la aplicación <em>myOng</em></span></a></h1>
